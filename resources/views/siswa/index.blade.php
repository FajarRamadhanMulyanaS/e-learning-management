...
@section('konten')
    <style>
        ...
        /* Enhanced jurusan cards responsiveness */
        .jurusan-card {
            display: flex;
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-success text-white">
                            <h5 class="mb-0"><i class="fa-solid fa-calendar-day"></i> Jadwal Pelajaran Hari Ini
                                ({{ $hariIni }})</h5>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered table-hover text-center align-middle">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">Tidak ada jadwal untuk hari
                                                {{ $hariIni }}.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                    ...
                    <div class="jurusan-section">
                        <div class="jurusan-header">
                            <h2 class="text-primary"><i class="fa-solid fa-book-open-reader"></i> Struktur Mata Pelajaran
                                per Jurusan</h2>
                            <p class="text-muted">Pelajari struktur pembelajaran berdasarkan jurusan untuk memahami
                                kompetensi yang dikembangkan pada setiap semester.</p>
                        </div>

                        {{-- Administrasi Bisnis --}}
                        <div class="jurusan-card">
                            <img src="https://img.freepik.com/free-photo/business-meeting-office_155003-4211.jpg"
                                alt="Administrasi Bisnis">
                            <div class="jurusan-content">
                                <h4>Administrasi Bisnis</h4>
                                <p>Jurusan ini berfokus pada keterampilan administrasi modern, komunikasi bisnis, dan
                                    penggunaan perangkat lunak perkantoran yang mendukung efisiensi kerja di dunia usaha.
                                </p>
                        ...
                        {{-- Akuntansi Komputer --}}
                        <div class="jurusan-card">
                            <img src="https://img.freepik.com/free-photo/close-up-hand-calculating-bills_1098-20227.jpg"
                                alt="Akuntansi Komputer">
                            <div class="jurusan-content">
                                <h4>Akuntansi Komputer</h4>
                                <p>Jurusan ini menggabungkan ilmu akuntansi dengan teknologi komputer untuk mengelola data
                                    keuangan secara cepat, akurat, dan modern menggunakan berbagai software akuntansi.</p>
                        ...
                        {{-- Desain Grafis --}}
                        <div class="jurusan-card">
                            <img src="https://img.freepik.com/free-photo/graphic-designer-working-modern-office_155003-10268.jpg"
                                alt="Desain Grafis">
                            <div class="jurusan-content">
                                <h4>Desain Grafis</h4>
                                <p>Jurusan ini melatih kreativitas dalam menciptakan karya visual digital menggunakan
                                    perangkat lunak desain, serta mengasah kemampuan komunikasi visual profesional.</p>
